...
- [ABB Externally Guided Motion](https://library.e.abb.com/public/f05090fae99a4d0ba2ee332e50865791/3HAC073318%20AM%20Externally%20Guided%20Motion%20RW7-en.pdf) - Useful to implement network communication between ABB robots and other devices. We used this approach to create a direct communication between Hololens 2 and our industrial robots. One may argue that we could have used ABB SDKs, but the SDKs didn't provide (at that moment) support for Unity applications. 
- [ABB PC SDK](https://developercenter.robotstudio.com/pc-sdk) Probably one of the most intuitive approaches to implement communication between ABB robots and a computer. We used the PC SDK to implement our block-based languages through WPF applications in .NET environments.
